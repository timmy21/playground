本文介绍SASL/SCRAM模式下，如何配置ACL的问题

## 服务端
#### 设置config/sasl_scram/server.properties
```
...
#### 增加admin的JAAS文件：config/sasl_scram/kafka_client_admin_jaas.conf
```
KafkaClient{
...
#### 创建主题
```
KAFKA_OPTS=-Djava.security.auth.login.config=/opt/kafka_2.12-2.4.1/config/sasl_scram/kafka_client_admin_jaas.conf \
